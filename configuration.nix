...
in
{
  ...
  hardware.graphics = {
    enable = true;
    enable32Bit = true; # Пригодится, если потом захочешь запустить Steam или старый софт
  };

  # Шаг 2: Заставляем Firefox использовать нативный Wayland (убирает тиринг и улучшает рендер)
